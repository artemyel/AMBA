$(function (e) {
    ...
    updateTheBirthDayValue = function (e, a, t, r, n) {
        ...
        var l = t.attr("id").replace(/-/g, ""), o = e("<fieldset class='birthdayPicker'></fieldset>"), d = e("<select class='birthYear " + i.sizeClass + "' name='" + l + "_birth[year]'></select>"), p = e("<select class='birthMonth " + i.sizeClass + "' name='" + l + "_birth[month]'></select>"), s = e("<select class='birthDate " + i.sizeClass + "' name='" + l + "_birth[day]'></select>");
